...
class ConversationProfilesClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2beta1.ConversationProfiles', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.conversationProfilesStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.v2beta1.ConversationProfiles')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.v2beta1
                    .ConversationProfiles, this._opts, this._providedCustomServicePath);
     ...
     * @returns {Stream}
     *   An object stream which emits an object representing [ConversationProfile]{@link google.cloud.dialogflow.v2beta1.ConversationProfile} on 'data' event.
     ...
     *   [ConversationProfile]{@link google.cloud.dialogflow.v2beta1.ConversationProfile}. The API will be called under the hood as needed, once per the page,
