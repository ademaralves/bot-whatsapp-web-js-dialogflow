...
exports.ParticipantsClient = void 0;
/* global window */
 ...
 */
const gapicConfig = require("./participants_client_config.json");
...
class ParticipantsClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            ...
            listSuggestions: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'suggestions'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2beta1.Participants', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.participantsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.v2beta1.Participants')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.v2beta1.Participants, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of participantsStubMethods) {
            const callPromise = this.participantsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createParticipant(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    updateParticipant(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    analyzeContent(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    suggestArticles(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    suggestFaqAnswers(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    suggestSmartReplies(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    compileSuggestion(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        this.warn('DEP$Participants-$CompileSuggestion', 'CompileSuggestion is deprecated and may be removed in a future version.', 'DeprecationWarning');
    ...
    listSuggestions(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        this.warn('DEP$Participants-$ListSuggestions', 'ListSuggestions is deprecated and may be removed in a future version.', 'DeprecationWarning');
     ...
     */
    listSuggestionsStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        this.initialize();
        this.warn('DEP$Participants-$ListSuggestions', 'ListSuggestions is deprecated and may be removed in a future version.', 'DeprecationWarning');
        return this.descriptors.page.listSuggestions.createStream(this.innerApiCalls.listSuggestions, request, callSettings);
    }
    /**
     ...
     * @deprecated ListSuggestions is deprecated and may be removed in a future version.
     */
    listSuggestionsAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        this.initialize();
        this.warn('DEP$Participants-$ListSuggestions', 'ListSuggestions is deprecated and may be removed in a future version.', 'DeprecationWarning');
        return this.descriptors.page.listSuggestions.asyncIterate(this.innerApiCalls['listSuggestions'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
//# sourceMappingURL=participants_client.js.map