...
export declare class VersionsClient {
     ...
     *   The first element of the array is an object representing [Version]{@link google.cloud.dialogflow.v2beta1.Version}.
     *   Please see the
     ...
     */
    getVersion(request?: protos.google.cloud.dialogflow.v2beta1.IGetVersionRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2beta1.IVersion, protos.google.cloud.dialogflow.v2beta1.IGetVersionRequest | undefined, {} | undefined]>;
    getVersion(request: protos.google.cloud.dialogflow.v2beta1.IGetVersionRequest, options: CallOptions, callback: Callback<protos.google.cloud.dialogflow.v2beta1.IVersion, protos.google.cloud.dialogflow.v2beta1.IGetVersionRequest | null | undefined, {} | null | undefined>): void;
    getVersion(request: protos.google.cloud.dialogflow.v2beta1.IGetVersionRequest, callback: Callback<protos.google.cloud.dialogflow.v2beta1.IVersion, protos.google.cloud.dialogflow.v2beta1.IGetVersionRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     * @param {google.cloud.dialogflow.v2beta1.Version} request.version
     ...
     */
    createVersion(request?: protos.google.cloud.dialogflow.v2beta1.ICreateVersionRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2beta1.IVersion, protos.google.cloud.dialogflow.v2beta1.ICreateVersionRequest | undefined, {} | undefined]>;
    createVersion(request: protos.google.cloud.dialogflow.v2beta1.ICreateVersionRequest, options: CallOptions, callback: Callback<protos.google.cloud.dialogflow.v2beta1.IVersion, protos.google.cloud.dialogflow.v2beta1.ICreateVersionRequest | null | undefined, {} | null | undefined>): void;
    createVersion(request: protos.google.cloud.dialogflow.v2beta1.ICreateVersionRequest, callback: Callback<protos.google.cloud.dialogflow.v2beta1.IVersion, protos.google.cloud.dialogflow.v2beta1.ICreateVersionRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    updateVersion(request?: protos.google.cloud.dialogflow.v2beta1.IUpdateVersionRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2beta1.IVersion, protos.google.cloud.dialogflow.v2beta1.IUpdateVersionRequest | undefined, {} | undefined]>;
    updateVersion(request: protos.google.cloud.dialogflow.v2beta1.IUpdateVersionRequest, options: CallOptions, callback: Callback<protos.google.cloud.dialogflow.v2beta1.IVersion, protos.google.cloud.dialogflow.v2beta1.IUpdateVersionRequest | null | undefined, {} | null | undefined>): void;
    updateVersion(request: protos.google.cloud.dialogflow.v2beta1.IUpdateVersionRequest, callback: Callback<protos.google.cloud.dialogflow.v2beta1.IVersion, protos.google.cloud.dialogflow.v2beta1.IUpdateVersionRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    deleteVersion(request?: protos.google.cloud.dialogflow.v2beta1.IDeleteVersionRequest, options?: CallOptions): Promise<[protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2beta1.IDeleteVersionRequest | undefined, {} | undefined]>;
    deleteVersion(request: protos.google.cloud.dialogflow.v2beta1.IDeleteVersionRequest, options: CallOptions, callback: Callback<protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2beta1.IDeleteVersionRequest | null | undefined, {} | null | undefined>): void;
    deleteVersion(request: protos.google.cloud.dialogflow.v2beta1.IDeleteVersionRequest, callback: Callback<protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2beta1.IDeleteVersionRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is Array of [Version]{@link google.cloud.dialogflow.v2beta1.Version}.
    ...
    listVersions(request: protos.google.cloud.dialogflow.v2beta1.IListVersionsRequest, callback: PaginationCallback<protos.google.cloud.dialogflow.v2beta1.IListVersionsRequest, protos.google.cloud.dialogflow.v2beta1.IListVersionsResponse | null | undefined, protos.google.cloud.dialogflow.v2beta1.IVersion>): void;
    /**
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing [Version]{@link google.cloud.dialogflow.v2beta1.Version} on 'data' event.
     *   The client library will perform auto-pagination by default: it will call the API as many
     ...
     *   for more details and examples.
     */
    listVersionsStream(request?: protos.google.cloud.dialogflow.v2beta1.IListVersionsRequest, options?: CallOptions): Transform;
    /**
     ...
     *   [Version]{@link google.cloud.dialogflow.v2beta1.Version}. The API will be called under the hood as needed, once per the page,
     ...
     */
    listVersionsAsync(request?: protos.google.cloud.dialogflow.v2beta1.IListVersionsRequest, options?: CallOptions): AsyncIterable<protos.google.cloud.dialogflow.v2beta1.IVersion>;
    /**
