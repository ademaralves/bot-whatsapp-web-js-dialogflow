...
exports.FulfillmentsClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v2beta1/fulfillments_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./fulfillments_client_config.json");
...
class FulfillmentsClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2beta1.Fulfillments', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.fulfillmentsStub) {
            return this.fulfillmentsStub;
        }
        // Put together the "service stub" for
        // google.cloud.dialogflow.v2beta1.Fulfillments.
        this.fulfillmentsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.v2beta1.Fulfillments')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.v2beta1.Fulfillments, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const fulfillmentsStubMethods = ['getFulfillment', 'updateFulfillment'];
        for (const methodName of fulfillmentsStubMethods) {
            const callPromise = this.fulfillmentsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getFulfillment(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    updateFulfillment(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
//# sourceMappingURL=fulfillments_client.js.map