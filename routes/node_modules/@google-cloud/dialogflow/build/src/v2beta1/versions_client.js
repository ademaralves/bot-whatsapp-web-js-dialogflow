 ...
 */
const gapicConfig = require("./versions_client_config.json");
...
class VersionsClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2beta1.Versions', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.versionsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.v2beta1.Versions')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.v2beta1.Versions, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of versionsStubMethods) {
            const callPromise = this.versionsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createVersion(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
//# sourceMappingURL=versions_client.js.map