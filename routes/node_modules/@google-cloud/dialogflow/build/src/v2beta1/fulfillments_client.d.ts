 ...
 * @memberof v2beta1
 */
export declare class FulfillmentsClient {
    private _terminated;
    private _opts;
    ...
    fulfillmentsStub?: Promise<{
        [name: string]: Function;
    }>;
    /**
     * Construct an instance of FulfillmentsClient.
     *
     ...
     *   The first element of the array is an object representing [Fulfillment]{@link google.cloud.dialogflow.v2beta1.Fulfillment}.
     *   Please see the
     *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
     *   for more details and examples.
     * @example <caption>include:samples/generated/v2beta1/fulfillments.get_fulfillment.js</caption>
     * region_tag:dialogflow_v2beta1_generated_Fulfillments_GetFulfillment_async
     */
    getFulfillment(request?: protos.google.cloud.dialogflow.v2beta1.IGetFulfillmentRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2beta1.IFulfillment, protos.google.cloud.dialogflow.v2beta1.IGetFulfillmentRequest | undefined, {} | undefined]>;
    getFulfillment(request: protos.google.cloud.dialogflow.v2beta1.IGetFulfillmentRequest, options: CallOptions, callback: Callback<protos.google.cloud.dialogflow.v2beta1.IFulfillment, protos.google.cloud.dialogflow.v2beta1.IGetFulfillmentRequest | null | undefined, {} | null | undefined>): void;
    getFulfillment(request: protos.google.cloud.dialogflow.v2beta1.IGetFulfillmentRequest, callback: Callback<protos.google.cloud.dialogflow.v2beta1.IFulfillment, protos.google.cloud.dialogflow.v2beta1.IGetFulfillmentRequest | null | undefined, {} | null | undefined>): void;
    /**
     * Updates the fulfillment.
     *
     * @param {Object} request
     *   The request object that will be sent.
     * @param {google.cloud.dialogflow.v2beta1.Fulfillment} request.fulfillment
     ...
     *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
     *   for more details and examples.
     * @example <caption>include:samples/generated/v2beta1/fulfillments.update_fulfillment.js</caption>
     * region_tag:dialogflow_v2beta1_generated_Fulfillments_UpdateFulfillment_async
     */
    updateFulfillment(request?: protos.google.cloud.dialogflow.v2beta1.IUpdateFulfillmentRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2beta1.IFulfillment, (protos.google.cloud.dialogflow.v2beta1.IUpdateFulfillmentRequest | undefined), {} | undefined]>;
    updateFulfillment(request: protos.google.cloud.dialogflow.v2beta1.IUpdateFulfillmentRequest, options: CallOptions, callback: Callback<protos.google.cloud.dialogflow.v2beta1.IFulfillment, protos.google.cloud.dialogflow.v2beta1.IUpdateFulfillmentRequest | null | undefined, {} | null | undefined>): void;
    updateFulfillment(request: protos.google.cloud.dialogflow.v2beta1.IUpdateFulfillmentRequest, callback: Callback<protos.google.cloud.dialogflow.v2beta1.IFulfillment, protos.google.cloud.dialogflow.v2beta1.IUpdateFulfillmentRequest | null | undefined, {} | null | undefined>): void;
    /**
