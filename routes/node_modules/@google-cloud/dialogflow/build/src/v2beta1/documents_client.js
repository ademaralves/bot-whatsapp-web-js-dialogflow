...
class DocumentsClient {
    ...
    constructor(opts) {
        ...
        const importDocumentsResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2beta1.ImportDocumentsResponse');
        const importDocumentsMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2beta1.KnowledgeOperationMetadata');
    ...
    initialize() {
        ...
        this.documentsStub = this._gaxGrpc.createStub(this._opts.fallback
            ...
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.v2beta1.Documents, this._opts, this._providedCustomServicePath);
