...
class EnvironmentsClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            ...
            getEnvironmentHistory: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'entries'),
        };
    ...
    initialize() {
        ...
        this.environmentsStub = this._gaxGrpc.createStub(this._opts.fallback
            ...
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.v2beta1.Environments, this._opts, this._providedCustomServicePath);
    ...
    getEnvironmentHistory(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    getEnvironmentHistoryStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.getEnvironmentHistory.createStream(this.innerApiCalls.getEnvironmentHistory, request, callSettings);
    }
    /**
    ...
    getEnvironmentHistoryAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.getEnvironmentHistory.asyncIterate(this.innerApiCalls['getEnvironmentHistory'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
