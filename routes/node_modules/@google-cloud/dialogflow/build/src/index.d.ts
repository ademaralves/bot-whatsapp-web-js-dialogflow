...
declare type AgentsClient = v2.AgentsClient;
declare const AnswerRecordsClient: typeof v2.AnswerRecordsClient;
declare type AnswerRecordsClient = v2.AnswerRecordsClient;
declare const ContextsClient: typeof v2.ContextsClient;
declare type ContextsClient = v2.ContextsClient;
declare const ConversationProfilesClient: typeof v2.ConversationProfilesClient;
declare type ConversationProfilesClient = v2.ConversationProfilesClient;
declare const ConversationsClient: typeof v2.ConversationsClient;
declare type ConversationsClient = v2.ConversationsClient;
declare const DocumentsClient: typeof v2.DocumentsClient;
declare type DocumentsClient = v2.DocumentsClient;
declare const EntityTypesClient: typeof v2.EntityTypesClient;
declare type EntityTypesClient = v2.EntityTypesClient;
declare const EnvironmentsClient: typeof v2.EnvironmentsClient;
declare type EnvironmentsClient = v2.EnvironmentsClient;
declare const FulfillmentsClient: typeof v2.FulfillmentsClient;
declare type FulfillmentsClient = v2.FulfillmentsClient;
declare const IntentsClient: typeof v2.IntentsClient;
declare type IntentsClient = v2.IntentsClient;
declare const KnowledgeBasesClient: typeof v2.KnowledgeBasesClient;
declare type KnowledgeBasesClient = v2.KnowledgeBasesClient;
declare const ParticipantsClient: typeof v2.ParticipantsClient;
declare type ParticipantsClient = v2.ParticipantsClient;
declare const SessionEntityTypesClient: typeof v2.SessionEntityTypesClient;
declare type SessionEntityTypesClient = v2.SessionEntityTypesClient;
declare const SessionsClient: typeof v2.SessionsClient;
declare type SessionsClient = v2.SessionsClient;
declare const VersionsClient: typeof v2.VersionsClient;
declare type VersionsClient = v2.VersionsClient;
export { v2, v2beta1, AgentsClient, AnswerRecordsClient, ContextsClient, ConversationProfilesClient, ConversationsClient, DocumentsClient, EntityTypesClient, EnvironmentsClient, FulfillmentsClient, IntentsClient, KnowledgeBasesClient, ParticipantsClient, SessionEntityTypesClient, SessionsClient, VersionsClient, };
