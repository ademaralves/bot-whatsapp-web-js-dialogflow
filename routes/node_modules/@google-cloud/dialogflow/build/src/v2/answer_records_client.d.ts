...
/**
 *  Service for managing {@link google.cloud.dialogflow.v2.AnswerRecord|AnswerRecords}.
 * @class
 * @memberof v2
 */
export declare class AnswerRecordsClient {
     ...
     */
    updateAnswerRecord(request?: protos.google.cloud.dialogflow.v2.IUpdateAnswerRecordRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2.IAnswerRecord, protos.google.cloud.dialogflow.v2.IUpdateAnswerRecordRequest | undefined, {} | undefined]>;
    updateAnswerRecord(request: protos.google.cloud.dialogflow.v2.IUpdateAnswerRecordRequest, options: CallOptions, callback: Callback<protos.google.cloud.dialogflow.v2.IAnswerRecord, protos.google.cloud.dialogflow.v2.IUpdateAnswerRecordRequest | null | undefined, {} | null | undefined>): void;
    updateAnswerRecord(request: protos.google.cloud.dialogflow.v2.IUpdateAnswerRecordRequest, callback: Callback<protos.google.cloud.dialogflow.v2.IAnswerRecord, protos.google.cloud.dialogflow.v2.IUpdateAnswerRecordRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is Array of [AnswerRecord]{@link google.cloud.dialogflow.v2.AnswerRecord}.
     ...
     *   for more details and examples.
     */
    listAnswerRecords(request?: protos.google.cloud.dialogflow.v2.IListAnswerRecordsRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2.IAnswerRecord[], protos.google.cloud.dialogflow.v2.IListAnswerRecordsRequest | null, protos.google.cloud.dialogflow.v2.IListAnswerRecordsResponse]>;
    listAnswerRecords(request: protos.google.cloud.dialogflow.v2.IListAnswerRecordsRequest, options: CallOptions, callback: PaginationCallback<protos.google.cloud.dialogflow.v2.IListAnswerRecordsRequest, protos.google.cloud.dialogflow.v2.IListAnswerRecordsResponse | null | undefined, protos.google.cloud.dialogflow.v2.IAnswerRecord>): void;
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing [AnswerRecord]{@link google.cloud.dialogflow.v2.AnswerRecord} on 'data' event.
     *   The client library will perform auto-pagination by default: it will call the API as many
     ...
     *   for more details and examples.
     */
    listAnswerRecordsStream(request?: protos.google.cloud.dialogflow.v2.IListAnswerRecordsRequest, options?: CallOptions): Transform;
    /**
     ...
     *   [AnswerRecord]{@link google.cloud.dialogflow.v2.AnswerRecord}. The API will be called under the hood as needed, once per the page,
     ...
     */
    listAnswerRecordsAsync(request?: protos.google.cloud.dialogflow.v2.IListAnswerRecordsRequest, options?: CallOptions): AsyncIterable<protos.google.cloud.dialogflow.v2.IAnswerRecord>;
    /**
