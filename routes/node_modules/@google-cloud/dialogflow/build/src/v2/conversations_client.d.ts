...
/**
 *  Service for managing {@link google.cloud.dialogflow.v2.Conversation|Conversations}.
 * @class
 * @memberof v2
 */
export declare class ConversationsClient {
     ...
     *
     * If {@link google.cloud.dialogflow.v2.Conversation.conversation_profile|Conversation.conversation_profile} is configured for a dialogflow
     ...
     * {@link google.cloud.dialogflow.v2.Intent|Intent} with {@link google.cloud.dialogflow.v2.Intent.live_agent_handoff|Intent.live_agent_handoff} is triggered, conversation
     ...
     *   "{@link a-zA-Z0-9_-|a-zA-Z}*" with the characters length in range of [3,64].
     ...
     */
    createConversation(request?: protos.google.cloud.dialogflow.v2.ICreateConversationRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2.IConversation, protos.google.cloud.dialogflow.v2.ICreateConversationRequest | undefined, {} | undefined]>;
     ...
     */
    getConversation(request?: protos.google.cloud.dialogflow.v2.IGetConversationRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2.IConversation, protos.google.cloud.dialogflow.v2.IGetConversationRequest | undefined, {} | undefined]>;
     ...
     */
    completeConversation(request?: protos.google.cloud.dialogflow.v2.ICompleteConversationRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2.IConversation, (protos.google.cloud.dialogflow.v2.ICompleteConversationRequest | undefined), {} | undefined]>;
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is Array of [Conversation]{@link google.cloud.dialogflow.v2.Conversation}.
     ...
     *   for more details and examples.
     */
    listConversations(request?: protos.google.cloud.dialogflow.v2.IListConversationsRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2.IConversation[], protos.google.cloud.dialogflow.v2.IListConversationsRequest | null, protos.google.cloud.dialogflow.v2.IListConversationsResponse]>;
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing [Conversation]{@link google.cloud.dialogflow.v2.Conversation} on 'data' event.
     *   The client library will perform auto-pagination by default: it will call the API as many
     ...
     *   [Conversation]{@link google.cloud.dialogflow.v2.Conversation}. The API will be called under the hood as needed, once per the page,
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is Array of [Message]{@link google.cloud.dialogflow.v2.Message}.
     *   The client library will perform auto-pagination by default: it will call the API as many
     *   times as needed and will merge results from all the pages into this array.
     *   Note that it can affect your quota.
     ...
     *   for more details and examples.
     */
    listMessages(request?: protos.google.cloud.dialogflow.v2.IListMessagesRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2.IMessage[], protos.google.cloud.dialogflow.v2.IListMessagesRequest | null, protos.google.cloud.dialogflow.v2.IListMessagesResponse]>;
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing [Message]{@link google.cloud.dialogflow.v2.Message} on 'data' event.
     *   The client library will perform auto-pagination by default: it will call the API as many
     *   times as needed. Note that it can affect your quota.
     *   We recommend using `listMessagesAsync()`
     *   method described below for async iteration which you can stop as needed.
     ...
     *   An iterable Object that allows [async iteration](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols).
     *   When you iterate the returned iterable, each element will be an object representing
     *   [Message]{@link google.cloud.dialogflow.v2.Message}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the
     *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination)
     *   for more details and examples.
