...
export declare class ConversationProfilesClient {
     ...
     *   The first element of the array is an object representing [ConversationProfile]{@link google.cloud.dialogflow.v2.ConversationProfile}.
     *   Please see the
     ...
     */
    getConversationProfile(request?: protos.google.cloud.dialogflow.v2.IGetConversationProfileRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2.IConversationProfile, (protos.google.cloud.dialogflow.v2.IGetConversationProfileRequest | undefined), {} | undefined]>;
    getConversationProfile(request: protos.google.cloud.dialogflow.v2.IGetConversationProfileRequest, options: CallOptions, callback: Callback<protos.google.cloud.dialogflow.v2.IConversationProfile, protos.google.cloud.dialogflow.v2.IGetConversationProfileRequest | null | undefined, {} | null | undefined>): void;
    getConversationProfile(request: protos.google.cloud.dialogflow.v2.IGetConversationProfileRequest, callback: Callback<protos.google.cloud.dialogflow.v2.IConversationProfile, protos.google.cloud.dialogflow.v2.IGetConversationProfileRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    createConversationProfile(request?: protos.google.cloud.dialogflow.v2.ICreateConversationProfileRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2.IConversationProfile, (protos.google.cloud.dialogflow.v2.ICreateConversationProfileRequest | undefined), {} | undefined]>;
    createConversationProfile(request: protos.google.cloud.dialogflow.v2.ICreateConversationProfileRequest, options: CallOptions, callback: Callback<protos.google.cloud.dialogflow.v2.IConversationProfile, protos.google.cloud.dialogflow.v2.ICreateConversationProfileRequest | null | undefined, {} | null | undefined>): void;
    createConversationProfile(request: protos.google.cloud.dialogflow.v2.ICreateConversationProfileRequest, callback: Callback<protos.google.cloud.dialogflow.v2.IConversationProfile, protos.google.cloud.dialogflow.v2.ICreateConversationProfileRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    updateConversationProfile(request?: protos.google.cloud.dialogflow.v2.IUpdateConversationProfileRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2.IConversationProfile, (protos.google.cloud.dialogflow.v2.IUpdateConversationProfileRequest | undefined), {} | undefined]>;
    updateConversationProfile(request: protos.google.cloud.dialogflow.v2.IUpdateConversationProfileRequest, options: CallOptions, callback: Callback<protos.google.cloud.dialogflow.v2.IConversationProfile, protos.google.cloud.dialogflow.v2.IUpdateConversationProfileRequest | null | undefined, {} | null | undefined>): void;
    updateConversationProfile(request: protos.google.cloud.dialogflow.v2.IUpdateConversationProfileRequest, callback: Callback<protos.google.cloud.dialogflow.v2.IConversationProfile, protos.google.cloud.dialogflow.v2.IUpdateConversationProfileRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    deleteConversationProfile(request?: protos.google.cloud.dialogflow.v2.IDeleteConversationProfileRequest, options?: CallOptions): Promise<[protos.google.protobuf.IEmpty, (protos.google.cloud.dialogflow.v2.IDeleteConversationProfileRequest | undefined), {} | undefined]>;
    deleteConversationProfile(request: protos.google.cloud.dialogflow.v2.IDeleteConversationProfileRequest, options: CallOptions, callback: Callback<protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2.IDeleteConversationProfileRequest | null | undefined, {} | null | undefined>): void;
    deleteConversationProfile(request: protos.google.cloud.dialogflow.v2.IDeleteConversationProfileRequest, callback: Callback<protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2.IDeleteConversationProfileRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is Array of [ConversationProfile]{@link google.cloud.dialogflow.v2.ConversationProfile}.
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing [ConversationProfile]{@link google.cloud.dialogflow.v2.ConversationProfile} on 'data' event.
     *   The client library will perform auto-pagination by default: it will call the API as many
     ...
     *   for more details and examples.
     */
    listConversationProfilesStream(request?: protos.google.cloud.dialogflow.v2.IListConversationProfilesRequest, options?: CallOptions): Transform;
    /**
     ...
     *   [ConversationProfile]{@link google.cloud.dialogflow.v2.ConversationProfile}. The API will be called under the hood as needed, once per the page,
     ...
     */
    listConversationProfilesAsync(request?: protos.google.cloud.dialogflow.v2.IListConversationProfilesRequest, options?: CallOptions): AsyncIterable<protos.google.cloud.dialogflow.v2.IConversationProfile>;
    /**
