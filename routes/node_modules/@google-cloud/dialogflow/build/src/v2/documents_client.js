...
class DocumentsClient {
    ...
    constructor(opts) {
        ...
        const createDocumentResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.Document');
        const createDocumentMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.KnowledgeOperationMetadata');
        const deleteDocumentResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteDocumentMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.KnowledgeOperationMetadata');
        const updateDocumentResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.Document');
        const updateDocumentMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.KnowledgeOperationMetadata');
        const reloadDocumentResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.Document');
        const reloadDocumentMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.KnowledgeOperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2.Documents', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.documentsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.v2.Documents')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.v2.Documents, this._opts, this._providedCustomServicePath);
