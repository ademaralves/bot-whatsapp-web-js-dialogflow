...
exports.ConversationProfilesClient = void 0;
/* global window */
const gax = require("google-gax");
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v2/conversation_profiles_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./conversation_profiles_client_config.json");
...
class ConversationProfilesClient {
    ...
    constructor(opts) {
        ...
        this.pathTemplates = {
            cXSecuritySettingsPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/securitySettings/{security_settings}'),
        ...
        this.descriptors.page = {
            listConversationProfiles: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'conversationProfiles'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2.ConversationProfiles', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.conversationProfilesStub) {
            return this.conversationProfilesStub;
        }
        // Put together the "service stub" for
        // google.cloud.dialogflow.v2.ConversationProfiles.
        this.conversationProfilesStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.v2.ConversationProfiles')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.v2.ConversationProfiles, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const conversationProfilesStubMethods = [
        ...
        for (const methodName of conversationProfilesStubMethods) {
            const callPromise = this.conversationProfilesStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getConversationProfile(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    createConversationProfile(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    updateConversationProfile(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    deleteConversationProfile(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listConversationProfiles(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.listConversationProfiles(request, options, callback);
    }
    /**
    ...
    listConversationProfilesStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listConversationProfiles.createStream(this.innerApiCalls.listConversationProfiles, request, callSettings);
    }
    /**
    ...
    listConversationProfilesAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listConversationProfiles.asyncIterate(this.innerApiCalls['listConversationProfiles'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
    ...
    matchProjectFromCXSecuritySettingsName(cXSecuritySettingsName) {
        return this.pathTemplates.cXSecuritySettingsPathTemplate.match(cXSecuritySettingsName).project;
    }
    /**
    ...
    matchLocationFromCXSecuritySettingsName(cXSecuritySettingsName) {
        return this.pathTemplates.cXSecuritySettingsPathTemplate.match(cXSecuritySettingsName).location;
    }
    /**
    ...
    matchSecuritySettingsFromCXSecuritySettingsName(cXSecuritySettingsName) {
        return this.pathTemplates.cXSecuritySettingsPathTemplate.match(cXSecuritySettingsName).security_settings;
    }
    /**
...
//# sourceMappingURL=conversation_profiles_client.js.map