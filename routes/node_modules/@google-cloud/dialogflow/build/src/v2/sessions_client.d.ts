...
export declare class SessionsClient {
     ...
     */
    detectIntent(request?: protos.google.cloud.dialogflow.v2.IDetectIntentRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2.IDetectIntentResponse, protos.google.cloud.dialogflow.v2.IDetectIntentRequest | undefined, {} | undefined]>;
    detectIntent(request: protos.google.cloud.dialogflow.v2.IDetectIntentRequest, options: CallOptions, callback: Callback<protos.google.cloud.dialogflow.v2.IDetectIntentResponse, protos.google.cloud.dialogflow.v2.IDetectIntentRequest | null | undefined, {} | null | undefined>): void;
    detectIntent(request: protos.google.cloud.dialogflow.v2.IDetectIntentRequest, callback: Callback<protos.google.cloud.dialogflow.v2.IDetectIntentResponse, protos.google.cloud.dialogflow.v2.IDetectIntentRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     * @returns {string} Resource name string.
     */
    projectLocationAgentEnvironmentUserSessionPath(project: string, location: string, environment: string, user: string, session: string): string;
    /**
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromProjectLocationAgentEnvironmentUserSessionName(projectLocationAgentEnvironmentUserSessionName: string): string | number;
    /**
     ...
     * @returns {string} A string representing the location.
     */
    matchLocationFromProjectLocationAgentEnvironmentUserSessionName(projectLocationAgentEnvironmentUserSessionName: string): string | number;
    /**
     ...
     * @returns {string} A string representing the environment.
     */
    matchEnvironmentFromProjectLocationAgentEnvironmentUserSessionName(projectLocationAgentEnvironmentUserSessionName: string): string | number;
    /**
     ...
     * @returns {string} A string representing the user.
     */
    matchUserFromProjectLocationAgentEnvironmentUserSessionName(projectLocationAgentEnvironmentUserSessionName: string): string | number;
    /**
     ...
     * @returns {string} A string representing the session.
     */
    matchSessionFromProjectLocationAgentEnvironmentUserSessionName(projectLocationAgentEnvironmentUserSessionName: string): string | number;
    /**
