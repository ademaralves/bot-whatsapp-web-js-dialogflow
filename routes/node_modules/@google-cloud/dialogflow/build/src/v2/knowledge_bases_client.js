 ...
 * `src/v2/knowledge_bases_client_config.json`.
...
class KnowledgeBasesClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2.KnowledgeBases', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.knowledgeBasesStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.v2.KnowledgeBases')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.v2.KnowledgeBases, this._opts, this._providedCustomServicePath);
