...
/**
 *  Service for managing {@link google.cloud.dialogflow.v2.Intent|Intents}.
 * @class
 * @memberof v2
 */
export declare class IntentsClient {
     ...
     */
    getIntent(request?: protos.google.cloud.dialogflow.v2.IGetIntentRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2.IIntent, protos.google.cloud.dialogflow.v2.IGetIntentRequest | undefined, {} | undefined]>;
    getIntent(request: protos.google.cloud.dialogflow.v2.IGetIntentRequest, options: CallOptions, callback: Callback<protos.google.cloud.dialogflow.v2.IIntent, protos.google.cloud.dialogflow.v2.IGetIntentRequest | null | undefined, {} | null | undefined>): void;
     ...
     */
    createIntent(request?: protos.google.cloud.dialogflow.v2.ICreateIntentRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2.IIntent, protos.google.cloud.dialogflow.v2.ICreateIntentRequest | undefined, {} | undefined]>;
    createIntent(request: protos.google.cloud.dialogflow.v2.ICreateIntentRequest, options: CallOptions, callback: Callback<protos.google.cloud.dialogflow.v2.IIntent, protos.google.cloud.dialogflow.v2.ICreateIntentRequest | null | undefined, {} | null | undefined>): void;
     ...
     */
    updateIntent(request?: protos.google.cloud.dialogflow.v2.IUpdateIntentRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2.IIntent, protos.google.cloud.dialogflow.v2.IUpdateIntentRequest | undefined, {} | undefined]>;
    updateIntent(request: protos.google.cloud.dialogflow.v2.IUpdateIntentRequest, options: CallOptions, callback: Callback<protos.google.cloud.dialogflow.v2.IIntent, protos.google.cloud.dialogflow.v2.IUpdateIntentRequest | null | undefined, {} | null | undefined>): void;
     ...
     */
    deleteIntent(request?: protos.google.cloud.dialogflow.v2.IDeleteIntentRequest, options?: CallOptions): Promise<[protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2.IDeleteIntentRequest | undefined, {} | undefined]>;
    deleteIntent(request: protos.google.cloud.dialogflow.v2.IDeleteIntentRequest, options: CallOptions, callback: Callback<protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2.IDeleteIntentRequest | null | undefined, {} | null | undefined>): void;
     ...
     */
    batchUpdateIntents(request?: protos.google.cloud.dialogflow.v2.IBatchUpdateIntentsRequest, options?: CallOptions): Promise<[LROperation<protos.google.cloud.dialogflow.v2.IBatchUpdateIntentsResponse, protos.google.protobuf.IStruct>, protos.google.longrunning.IOperation | undefined, {} | undefined]>;
    batchUpdateIntents(request: protos.google.cloud.dialogflow.v2.IBatchUpdateIntentsRequest, options: CallOptions, callback: Callback<LROperation<protos.google.cloud.dialogflow.v2.IBatchUpdateIntentsResponse, protos.google.protobuf.IStruct>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
     ...
     */
    batchDeleteIntents(request?: protos.google.cloud.dialogflow.v2.IBatchDeleteIntentsRequest, options?: CallOptions): Promise<[LROperation<protos.google.protobuf.IEmpty, protos.google.protobuf.IStruct>, protos.google.longrunning.IOperation | undefined, {} | undefined]>;
    batchDeleteIntents(request: protos.google.cloud.dialogflow.v2.IBatchDeleteIntentsRequest, options: CallOptions, callback: Callback<LROperation<protos.google.protobuf.IEmpty, protos.google.protobuf.IStruct>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
     ...
     *   for more details and examples.
     */
    listIntents(request?: protos.google.cloud.dialogflow.v2.IListIntentsRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2.IIntent[], protos.google.cloud.dialogflow.v2.IListIntentsRequest | null, protos.google.cloud.dialogflow.v2.IListIntentsResponse]>;
    listIntents(request: protos.google.cloud.dialogflow.v2.IListIntentsRequest, options: CallOptions, callback: PaginationCallback<protos.google.cloud.dialogflow.v2.IListIntentsRequest, protos.google.cloud.dialogflow.v2.IListIntentsResponse | null | undefined, protos.google.cloud.dialogflow.v2.IIntent>): void;
     ...
     *   for more details and examples.
     */
    listIntentsStream(request?: protos.google.cloud.dialogflow.v2.IListIntentsRequest, options?: CallOptions): Transform;
    /**
     ...
     *   [Intent]{@link google.cloud.dialogflow.v2.Intent}. The API will be called under the hood as needed, once per the page,
     ...
     */
    listIntentsAsync(request?: protos.google.cloud.dialogflow.v2.IListIntentsRequest, options?: CallOptions): AsyncIterable<protos.google.cloud.dialogflow.v2.IIntent>;
    /**
