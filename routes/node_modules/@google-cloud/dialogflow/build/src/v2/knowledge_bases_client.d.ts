...
/**
 *  Service for managing {@link google.cloud.dialogflow.v2.KnowledgeBase|KnowledgeBases}.
 * @class
 * @memberof v2
 */
export declare class KnowledgeBasesClient {
     ...
     */
    getKnowledgeBase(request?: protos.google.cloud.dialogflow.v2.IGetKnowledgeBaseRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2.IKnowledgeBase, protos.google.cloud.dialogflow.v2.IGetKnowledgeBaseRequest | undefined, {} | undefined]>;
     ...
     */
    createKnowledgeBase(request?: protos.google.cloud.dialogflow.v2.ICreateKnowledgeBaseRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2.IKnowledgeBase, protos.google.cloud.dialogflow.v2.ICreateKnowledgeBaseRequest | undefined, {} | undefined]>;
     ...
     */
    deleteKnowledgeBase(request?: protos.google.cloud.dialogflow.v2.IDeleteKnowledgeBaseRequest, options?: CallOptions): Promise<[protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2.IDeleteKnowledgeBaseRequest | undefined, {} | undefined]>;
     ...
     */
    updateKnowledgeBase(request?: protos.google.cloud.dialogflow.v2.IUpdateKnowledgeBaseRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2.IKnowledgeBase, protos.google.cloud.dialogflow.v2.IUpdateKnowledgeBaseRequest | undefined, {} | undefined]>;
     ...
     *   for more details and examples.
     */
    listKnowledgeBases(request?: protos.google.cloud.dialogflow.v2.IListKnowledgeBasesRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2.IKnowledgeBase[], protos.google.cloud.dialogflow.v2.IListKnowledgeBasesRequest | null, protos.google.cloud.dialogflow.v2.IListKnowledgeBasesResponse]>;
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing [KnowledgeBase]{@link google.cloud.dialogflow.v2.KnowledgeBase} on 'data' event.
     *   The client library will perform auto-pagination by default: it will call the API as many
     ...
     *   [KnowledgeBase]{@link google.cloud.dialogflow.v2.KnowledgeBase}. The API will be called under the hood as needed, once per the page,
