...
class ParticipantsClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2.Participants', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.participantsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.v2.Participants')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.v2.Participants, this._opts, this._providedCustomServicePath);
     ...
     * @returns {Stream}
     *   An object stream which emits an object representing [Participant]{@link google.cloud.dialogflow.v2.Participant} on 'data' event.
     ...
     *   [Participant]{@link google.cloud.dialogflow.v2.Participant}. The API will be called under the hood as needed, once per the page,
