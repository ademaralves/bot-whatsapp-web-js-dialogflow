...
/**
 *  Service for managing {@link google.cloud.dialogflow.v2.EntityType|EntityTypes}.
 * @class
 * @memberof v2
 */
export declare class EntityTypesClient {
     ...
     * - `response`: {@link google.cloud.dialogflow.v2.BatchUpdateEntityTypesResponse|BatchUpdateEntityTypesResponse}
     *
     * Note: You should always train an agent prior to sending it queries. See the
     * [training
     * documentation](https://cloud.google.com/dialogflow/es/docs/training).
     ...
     *   [EntityType]{@link google.cloud.dialogflow.v2.EntityType}. The API will be called under the hood as needed, once per the page,
